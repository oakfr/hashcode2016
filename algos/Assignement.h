...
// algo d'assignement lineaire
// assigner N elements X a N elements Y, 1 a 1, de facon a minimiser un matrice de cout
//
// parametres
//    cost : matrice de cout
//    n : nombre de ligne/colonne
//    xy : resultat, la colonne assignee a chaque ligne
//    yx : resultat, la ligne assignee a chaque colonne
...
int main()
{
  ...
  for (int x = 0; x < 3; ++x) { // affichage de la matrice de cout avec entre crochet les elements selectionnes
    for (int y = 0; y < 3; ++y) {
      if (xy[x] == y) {
        cout << '[' << cost[x][y] << "]\t";
      } else {
